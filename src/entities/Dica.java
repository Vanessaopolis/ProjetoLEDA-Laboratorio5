...
/**
 * Representação de uma dica, associa um autor, um tema e uma lista de
 * elementos. As dicas podem conter textos, mídias ou referências, e o autor é
 * bonificado com base nos elementos adicionados.
 * 
 * @author Alana Vanessa Pimentel Toldo de Andrade, matrícula 123210882
 * @author João Victor Muniz Cabral, matrícula 123210456
 */
...
public class Dica implements Comparable<Dica> {
	 ...
	 * @param tema  o tema da dica, que será convertido para um tipo de atividade
	 *              complementar
	 ...
	 *
	 * @param autor o usuário que está adicionando o texto, apenas o autor da dica
	 ...
	 *
	 * @param autor     o usuário que está adicionando o texto, apenas o autor da
	 *                  dica pode adicionar elementos
	 ...
	 */
	public boolean adicionaReferencia(Usuario autor, String titulo, String fonte, int ano, boolean conferida,
			int importancia) {
		if (!validaAutor(autor)) {
			return false;
		}
	...
	/**
	 * Compara esta dica com outra dica, baseando-se no autor e no tema.
	 * 
	 * A ordenação segue as seguintes regras:
	 * 
	 * Se as dicas tiverem o mesmo autor e o mesmo tema, são consideradas iguais
	 * (retorna 0).
	 * 
	 * Se as dicas tiverem o mesmo autor, mas temas diferentes, a ordenação é feita
	 * pelo nome do tema.
	 * 
	 * Se as dicas tiverem autores diferentes, a ordenação é feita pelo nome do
	 * autor.
	 * 
	 * @param obj o objeto a ser comparado com esta dica
	 * @return um valor negativo se esta dica vem antes da dica fornecida, zero se
	 *         elas forem iguais, e um valor positivo se esta dica vem depois,
	 *         seguindo a ordem estabelecida pelos critérios acima
