...
public class UsuarioRepositoryHashMap implements UsuarioRepository {
	 ...
	 */
	public UsuarioRepositoryHashMap() {
	...
	public String[] listaEstudantes() {
		...
		TreeSet<Usuario> estudantesOrdenadosAlfabeticamente = new TreeSet<>(this.estudantes.values());
	...
	public String[] listaEstudantesRankingDicas() {
		...
		estudantesOrdenadosPelaBonificacao.addAll(this.estudantes.values());
