...
public class MainDicaBuscaUltima {
	public static void main(String[] args) {
		String main = "MainDicaBuscaUltima";
		...
		try {
			...
			BufferedWriter writer = new BufferedWriter(new FileWriter("/home/ubuntu/ProjetoLEDA-Laboratorio5/data/resultadoDicaBuscaUltima.txt"));			
